...
const Formulario = ({ resultFunction, user_address }) => {
  ...
  const submitForm = (e) => {
    ...
    axios
      .post("http://localhost:8000/audit/upload/address", formData, {
        headers: {
  ...
  return (
    <div className="bg-info">
      ...
      <div className="container">
        <div className="row">
          <form onSubmit={submitForm} className="col card text-white bg-transparent mb-5 pt-5 pb-2">
            <fieldset>
              <legend className="text-center">Smart Contract Auditor</legend>
              ...
              <div className="row">
                ...
                <div className="col-md-6">
                  <div className="form-group">
                    ...
                    <MuiFileInput value={auditFile} onChange={(newFile) => setAuditFile(newFile)} />
                  </div>
                </div>
              </div>
              <div className={styles.grid}>
                <button type="submit" className={styles.grid}>
                  {" "}
                  Contribute
                </button>
              </div>
